...
extras_require = {
    ...
    'base': [
        ...
        'invenio-theme>=1.3.0a10,<1.4.0',
    ],
    'auth': [
        'invenio-access>=1.4.1,<1.5.0',
        'invenio-accounts>=1.4.0a5,<1.5.0',
        'invenio-oauth2server>=1.3.0a2,<1.4.0',
        'invenio-oauthclient>=1.4.0a1,<1.5.0',
        'invenio-userprofiles>=1.2.0a3,<1.3.0',
    ],
    'metadata': [
