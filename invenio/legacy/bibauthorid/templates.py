...
from invenio.legacy.bibauthorid.config import PERSONID_EXTERNAL_IDENTIFIER_MAP, CREATE_NEW_PERSON
from invenio.legacy.bibauthorid.webapi import get_person_redirect_link, get_canonical_id_from_person_id, \
     get_person_names_from_id, get_person_info_by_pid
from invenio.legacy.bibauthorid.frontinterface import get_uid_of_author
from invenio.legacy.bibauthorid.frontinterface import get_bibrefrec_name_string
from invenio.legacy.bibauthorid.frontinterface import get_canonical_name_of_author
