...
from invenio.legacy.bibauthorid.general_utils import is_arxiv_id_or_doi
...
from invenio.legacy.bibauthorid.dbinterface import get_external_ids_of_author, add_arxiv_papers_to_author, get_arxiv_papers_of_author  #pylint: disable-msg=W0614
