...
from invenio.legacy.webauthorprofile.publication_grapher import get_graph_code
...
from .config import CFG_WEBSEARCH_DEF_RECORDS_IN_GROUPS, \
...
from .config import CFG_WEBAUTHORPROFILE_MAX_COLLAB_LIST, \
