...
import invenio_access.admin_lib as wal
from invenio_access.local_config import CFG_ACC_EMPTY_ROLE_DEFINITION_SRC
# reload(wal)
# from invenio_access.admin_lib import index
