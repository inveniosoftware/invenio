...
"""
    invenio.modules.jsonalchemy.engines.cache
    -----------------------------------------

    This module wraps Flask-Cache as engine for JSONAlchemy.
"""
...
class CacheStorage(Storage):
    """
    Implements storage engine for Flask-Cache useful for testing.
    """
