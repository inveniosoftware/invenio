...
def do_upgrade():
    ...
    db.Column('url', db.String(length=100), server_default='', nullable=True),
    db.Column('title', db.String(length=200), server_default='', nullable=True),
    db.Column('content', db.TEXT(), server_default='', nullable=False),
