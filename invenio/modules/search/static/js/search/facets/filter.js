...
define([
  ...
  function Filter(element, options) {
    ...
    /**
     * Collects ids of the activated facet options.
     *
     * Structure:
     * {
     *   filter_type (state): [facet_option_id, facet_option_id, ...]
     *   filter_type (state): [facet_option_id, facet_option_id, ...]
     *   ...
     * }
     *
    ...
    /**
     * Collects paths of activated facet options.
     *
     * Structure:
     * {
  ...
  Filter.prototype = {
    ...
    init: function () {
      ...
      this.loadedPromise = this.$main_facet_box.facet_options_list(
        ...
        this._loadState(this.stored_state);
        this.is_loaded = true;
        }.bind(this));
