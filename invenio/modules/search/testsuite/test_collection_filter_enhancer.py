...
"""Tests for the policies on restricted and permitted collections and the query
   enhancer that applies them
"""

from invenio.testsuite import make_test_suite, run_test_suite, InvenioTestCase
from invenio_query_parser.ast import AndOp, OrOp, NotOp
