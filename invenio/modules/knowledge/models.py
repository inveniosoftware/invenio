...
class KnwKB(db.Model):
    ...
    _kbtype = db.Column(db.Enum('w', 't', 'd', name="kbtype"),
                        nullable=True, default='w', name="kbtype")
    ...
    def kbtype(self, value):
        ...
        kbtype = value[0]
        if kbtype != 't' and kbtype != 'd' and kbtype != 'w':
    ...
    def to_dict(self):
        ...
        mydict = {'id': self.id, 'name': self.name,
                  ...
                  'kbtype': self.kbtype}
        if self.kbtype == 'd':
            mydict.update(self.kbdefs.to_dict() or {})
    ...
    def get_kbr_values(self, searchkey="", searchvalue="", searchtype='s'):
        ...
        kvals = KnwKBRVAL.query.filter(
            ...
            KnwKBRVAL.m_value.like(searchvalue),
            KnwKBRVAL.m_key.like(searchkey)).all()
        return [[kval.m_value] for kval in kvals]
