...
class RankingTask(PeriodicTask):
    ...
    """
    run_every = cfg['COMMUNITIES_PERIODIC_TASKS']['ranking_deamon']['run_every']
...
def calculate_rank_for_community(community, max_recs_cnt):
    """
        ...
        4. calculate ranking points with formula:
           ...
           day_value = max_date_ranking/some_value (some_value example: 50 [days])
           C, C2 const.
    """
    factor = 5
    ...
    interval = (datetime.now() - community.last_record_accepted).days
