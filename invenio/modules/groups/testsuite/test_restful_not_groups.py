...
class TestNotGroupsRestfulAPI(APITestCase):

    """Test url /api/users/[:id_user]/not-groups."""
    ...
    def test_get_not_groups(self):
        """Test GET /api/users/<int:id_user>/not-groups."""
        pass


TEST_SUITE = make_test_suite(TestNotGroupsRestfulAPI)
