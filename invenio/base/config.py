...
CFG_ADS_SITE = 0
APACHE_GROUP_FILE = "demo-site-apache-user-groups"
APACHE_GUESS_CERT_PATHS = 1
APACHE_GUESS_LISTEN_DIRECTIVE = 1
APACHE_LISTEN_DIRECTIVE_HTTP = 0
APACHE_LISTEN_DIRECTIVE_HTTPS = 0
APACHE_PASSWORD_FILE = "demo-site-apache-user-passwords"
APACHE_RUNNING_AS_USER = "www-data"
