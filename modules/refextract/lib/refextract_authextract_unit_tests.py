...
class RefExtractReferenceParsingTest(unittest.TestCase):
    ...
    def setUp(self):
        self.reflines = ["""[1] <a href="http://cds.cern.ch/">CERN Document Server</a> J. Maldacena, Adv. Theor. Math. Phys. 2 (1998) 231; hep-th/9711200. http://cds.cern.ch/ then http://www.itp.ucsb.edu/online/susyc99/discussion/. ; L. Susskind, J. Math. Phys. 36 (1995) 6377; hep-th/9409089. hello world a<a href="http://uk.yahoo.com/">Yahoo!</a>. Fin.""",
                             """[1] J. Maldacena, Adv. Theor. Math. Phys. 2 (1998) 231; hep-th/9711200. http://cds.cern.ch/""",
                             """[2] S. Gubser, I. Klebanov and A. Polyakov, Phys. Lett. B428 (1998) 105; hep-th/9802109. http://cds.cern.ch/search.py?AGE=hello-world&ln=en""",
                             ...
                             """[25] C. Graham and J. Lee, Adv. Math. 87 (1991) 186. <a href="http://cds.cern.ch/">CERN Document Server</a>""",
