...
class InvenioOaiHarvestWebTest(InvenioWebTestCase):
    ...
    def test_insert_oai_source(self):
        ...
        self.choose_selectbox_option_by_index(selectbox_name="oai_src_frequency", index="3")
        self.choose_selectbox_option_by_index(selectbox_name="oai_src_lastrun", label="2")
        self.find_element_by_id_with_timeout(id="post_input_c0")
