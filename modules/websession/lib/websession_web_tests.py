...
class InvenioWebSessionWebTest(InvenioWebTestCase):
    ...
    def test_create_group(self):
        ...
        self.fill_textbox("group_name", "group test")
        self.fill_textbox("group_description", "test")
        self.choose_selectbox_option_by_label("join_policy", "Visible and open for new members")
    ...
    def test_create_open_group(self):
        ...
        self.find_element_by_name_with_timeout("create_group")
        self.browser.find_element_by_name("create_group").click()
        self.fill_textbox("group_name", "my_friends")
        self.fill_textbox("group_description", "all my friends")
        self.choose_selectbox_option_by_label("join_policy", "Visible and open for new members")
        self.find_element_by_name_with_timeout("create_button")
        self.browser.find_element_by_name("create_button").click()
        self.handle_popup_dialog()
        ...
        self.choose_selectbox_option_by_label("grpID", "my_friends")
    ...
    def test_set_group(self):
        ...
        self.fill_textbox("group_name", "my_friends")
        self.fill_textbox("group_description", "all my friends")
        self.choose_selectbox_option_by_label("join_policy", "Visible but new members need approval")
        self.find_element_by_name_with_timeout("create_button")
        self.browser.find_element_by_name("create_button").click()
        self.handle_popup_dialog()
        self.logout()
        ...
        self.choose_selectbox_option_by_label("pending_member_id", "romeo")
