...
<input class="formbutton" type="submit" name="action" value="%(set_new_password)s" />
    ...
    def tmpl_create_useractivities_menu(self, req, ln, selected, url_referer, guest, username, submitter, referee, admin, usebaskets, usemessages, usealerts, usegroups, useloans, usestats):
        """
    ...
    def tmpl_create_adminactivities_menu(self, req, ln, selected, url_referer, guest, username, submitter, referee, admin, usebaskets, usemessages, usealerts, usegroups, useloans, usestats, activities):
        """
        Returns the main navigation menu with actions based on user's
        priviledges
