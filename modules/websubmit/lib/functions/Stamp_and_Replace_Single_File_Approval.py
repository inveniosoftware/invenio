...
"""Stamp_and_Replace_Single_File_Approval: A function to allow a single file
...
def Stamp_and_Replace_Single_File_Approval(parameters, \
                                           curdir, \
                                           form, \
                                           user_info=None):
    ...
    try:
        ...
        err_msg = "Error in Stamp_and_Replace_Single_File_Approval: " \
    ...
    if name_file_to_stamp == "":
        wrn_msg = "Warning in Stamp_and_Replace_Single_File_Approval: " \
    ...
    try:
        ...
        try:
            ...
            wrn_msg = "Warning in Stamp_and_Replace_Single_File_" \
                      "Approval: It wasn't possible to recover a PDF " \
                ...
                if seekvalue_fname != "":
                    ...
                    if os.access("%s/%s" % (curdir, seekvalue_fname), \
                        ...
                        try:
                            ...
                            err_msg = "Error in Stamp_and_Replace_Single_" \
                                      "File_Approval: The " \
                    ...
                    err_msg = "Error in Stamp_and_Replace_Single_File_" \
    ...
    try:
        ...
        try:
            ...
            wrn_msg = "Warning in Stamp_and_Replace_Single_File" \
                      "_Approval: After having stamped the file with " \
                      "the name [%s] and the fullpath [%s], it wasn't " \
                      "possible to revise that file with the newly stamped " \
                      "version. Stamping was unsuccessful. The submission " \
                      "ID is [%s] and the record ID is [%s]." \
                      % (name_file_to_stamp, \
                         file_stamper_options['input-file'], \
                         access, \
                         recid)
            ...
            if new_file_name != "":
                try:
                    ...
                    wrn_msg = "Warning in Stamp_and_Replace_Single_File_" \
                              "Approval: After having stamped and " \
                              "revised the file with the name [%s] and the " \
                              "fullpath [%s], it wasn't possible to rename " \
                              "it to [%s]. The submission ID is [%s] and " \
                              "the record ID is [%s]." \
                              % (name_file_to_stamp, \
                                 file_stamper_options['input-file'], \
                                 new_file_name, \
