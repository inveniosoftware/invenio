...
from invenio.bibeditold_dblayer import get_marcxml_of_record_revision, \
    get_record_revisions, marc_to_split_tag
from invenio.bibeditold_utils import get_file_path, get_tmp_file_owner, \
...
bibedit_templates = invenio.template.load('bibeditold')
