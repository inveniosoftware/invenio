...
#actionsDisplayArea .header {
    ...
    def page_contents(self, language):
        """Returns HTML representing the MultiEdit page"""

        _ = gettext_set_language(language)

        page_html = """\
<span class="warning"><strong>FIXME</strong>: This interface is in early development and currently
allows only the <strong>preview</strong> functionality.</span>
<div class="pagebody">
...
<tr>
    ...
    <input type="text" id="textBoxSearchCriteria"  size="60">
    <input id="buttonTestSearch" value="%(text_test_search)s" type="button" class="formbutton"></button>
    </td>
</tr>
<tr>
    <td align="center">
...
<tbody class="lastRow" valign="middle"><tr><td colspan="7" align="left">
    <img src="%(site_url)s/img/add.png" class="buttonNewField" alt="."/>
...
<tbody class="templateNewField">
    ...
    <tr class="tagTableRow"><td /><td /><td>&nbsp;</td><td /><td colspan="2">
        <input value="%(text_save)s" type="button" class="buttonSaveNewField"/>
        <input value="%(text_cancel)s" type="button" class="buttonCancelNewField"/>
    </td><td/></tr>
</tbody>
...
<tbody class="templateDisplayField" valign="middle">
    <tr class="tagTableRow">
        <td><img src="%(site_url)s/img/delete.png" class="buttonDeleteField"/></td>
        <td>
            <strong>
        ...
        <td align="center">
            <img src="%(site_url)s/img/add.png" class="buttonNewSubfield" alt="."/>
...
<tr class="subfieldTableRow">
    <td />
    <td />
    <td><img src="%(site_url)s/img/delete.png" class="buttonDeleteSubfield" /></td>
...
<tbody class="templateNewSubfield">
    ...
    <tr class="valueParameters">
        <td /><td /><td /><td />
        <td colspan="3">
            <input class="txtValue textBoxValue" type="text" value="%(text_value)s"/>
        </td>
    </tr>
    ...
    <tr>
        <td /><td /><td /><td /><td>
            <input value="%(text_save)s" type="button" class="buttonSaveNewSubfield"/>
            <input value="%(text_cancel)s" type="button" class="buttonCancelNewSubfield">
        </td>
    </tr>
</tbody>
        ...
        """% {"site_url" : CFG_SITE_URL,
              ...
              "text_define_field" : _("Define field action"),
              "text_define_subfield" : _("Define subfield action"),
              "text_field" : _("Field"),
              ...
              "text_replace_text" : _("Replace text"),
              "text_replace_content" : _("Replace content"),
              "text_with" : _("with"),
    ...
    def _search_results_header(self, number_of_records, current_page, records_per_page, language):
    ...
    def search_results(self, records, number_of_records, current_page, records_per_page, language):
