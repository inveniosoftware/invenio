...
def loan_period_result(req, startDate, endDate, numberOfResults, ln=CFG_SITE_LANG):
    """
    ...
    @param numberOfResults:  top results

    @return:   list of recids
    """

    if startDate and endDate and numberOfResults:
        infos = []
        res = db.calculate(startDate, endDate, numberOfResults)
