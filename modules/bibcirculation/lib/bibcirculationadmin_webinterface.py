...
class WebInterfaceBibCirculationAdminPages(WebInterfaceDirectory):
    ...
    _exports = ['', 'index', 'borrower_search', 'item_search', 'borrower_notification',
        'get_pending_requests', 'item_search_result', 'loan_return', 'loan_on_desk_step1',
        'loan_on_desk_step2', 'loan_on_desk_step3', 'loan_on_desk_step4', 'loan_on_desk_confirm',
        'register_new_loan', 'loan_return_confirm', 'get_next_waiting_loan_request',
        'update_next_loan_request_status', 'all_requests', 'get_item_req_historical_overview',
        'get_item_loans_historical_overview', 'all_loans_test', 'all_loans',
        'bor_loans_historical_overview', 'bor_requests_historical_overview',
        'get_item_requests_details', 'get_item_loans_details', 'get_borrower_details',
        'get_item_details', 'get_library_details', 'get_borrower_requests_details',
        'get_borrower_loans_details', 'borrower_search_result', 'associate_barcode',
        'get_borrower_notes', 'get_loans_notes', 'get_item_loans_notes', 'new_item',
        'add_new_borrower_step1', 'add_new_borrower_step2', 'add_new_borrower_step3',
        'update_borrower_info_step1', 'update_borrower_info_step2', 'update_borrower_info_step3',
        'update_borrower_info_step4', 'update_borrower_info_step5', 'add_new_library_step1',
        'add_new_library_step2', 'add_new_library_step3', 'update_library_info_step1',
        'update_library_info_step2', 'update_library_info_step3', 'update_library_info_step4',
        'update_library_info_step5', 'new_book_step1', 'new_book_step2', 'add_new_copy_step1',
        'add_new_copy_step2', 'add_new_copy_step3', 'add_new_copy_step4', 'add_new_copy_step5',
        ...
        'search_library_step1', 'search_library_step2', 'get_library_notes',
        'change_due_date_step1', 'change_due_date_step2', 'claim_book_return',
        'all_expired_loans', 'get_waiting_requests', 'create_new_loan_step1',
        'create_new_loan_step2', 'create_new_request_step1', 'create_new_request_step2',
        'create_new_request_step3', 'create_new_request_step4', 'place_new_request_step1',
        'place_new_request_step2', 'place_new_request_step3', 'place_new_loan_step1',
        'place_new_loan_step2', 'place_new_loan_step3', 'order_new_copy_step1',
        'order_new_copy_step3', 'ordered_books', 'get_purchase_notes',
        'register_ill_request_step0', 'register_ill_request_step1', 'register_ill_request_step2',
        'register_ill_request_step3', 'list_ill_request', 'ill_request_details_step1',
        'ill_request_details_step2', 'ill_request_details_step3', 'ordered_books_details_step1',
        'ordered_books_details_step2', 'ordered_books_details_step3', 'add_new_vendor_step1',
        'add_new_vendor_step2', 'add_new_vendor_step3', 'update_vendor_info_step1',
        'update_vendor_info_step2', 'update_vendor_info_step3', 'update_vendor_info_step4',
        'update_vendor_info_step5', 'search_vendor_step1', 'search_vendor_step2',
        'get_vendor_details', 'get_vendor_notes', 'register_ill_request_with_no_recid_step1',
        'register_ill_request_with_no_recid_step2', 'register_ill_request_with_no_recid_step3',
        'register_ill_request_with_no_recid_step4', 'get_borrower_ill_details',
        'get_ill_library_notes', 'get_expired_loans_with_requests', 'register_ill_book_request',
        'register_ill_book_request_result', 'register_ill_book_request_from_borrower_page',
    ...
    def borrower_search(self, req, form):
        ...
        argd = wash_urlargd(form, {'empty_barcode': (str, None), 'redirect': (str, "no"),
                                    'ln': (str, "en")})
    ...
    def item_search_result(self, req, form):
        ...
        argd = wash_urlargd(form, {'p': (str, None), 'f': (str, None),
                                   'library_id': (str, 'all'), 'ln': (str, "en")})
        p  = argd['p']
        f  = argd['f']
        ...
        return bal.item_search_result(req, p, f, library_id, ln)
    ...
    def borrower_notification(self, req, form):
        ...
        argd = wash_urlargd(form, {'borrower_id': (str, None), 'borrower_email': (str, None),
            'template': (str, None), 'message': (str, None), 'load_msg_template': (str, None),
    ...
    def update_next_loan_request_status(self, req, form):
        ...
        return bal.update_next_loan_request_status(req, check_id, barcode, ln)
    ...
    def get_borrower_loans_details(self, req, form):
        ...
        argd = wash_urlargd(form, {'recid': (str, None), 'barcode': (str, None),
                                    'borrower_id': (str, None), 'renewall': (str, None),
    ...
    def add_new_borrower_step3(self, req, form):
        ...
        ln = argd['ln']
        tup_infos = eval(tup_infos) #function not in use
    ...
    def update_borrower_info_step4(self, req, form):
        ...
        argd = wash_urlargd(form, {'borrower_id': (str, None), 'name': (str, ''),
        ...
        return bal.update_borrower_info_step4(req, borrower_id, name, email, phone, address,
                                              mailbox, ln)


    def update_borrower_info_step5(self, req, form):
        """http://cdsweb.cern.ch/admin2/bibcirculation/update_borrower_info_step5"""
        argd = wash_urlargd(form, {'borrower_id': (str, None), 'name': (str, None),
            'email': (str, None), 'phone': (str, None), 'address': (str, None),
            'mailbox': (str, None), 'ln': (str, "en")})
        ...
        return bal.update_borrower_info_step5(req, borrower_id, name, email, phone, address,
                                              mailbox, ln)
    ...
    def order_new_copy_step3(self, req, form):
        ...
        order_info = eval(order_info) #function not in use
    ...
    def get_purchase_notes(self, req, form):
        ...
        argd = wash_urlargd(form, {'purchase_id': (str, None), 'delete_key': (str, None),
                                    'library_notes': (str, None), 'ln': (str, "en")})
    ...
    def register_ill_request_step0(self, req, form):
        ...
        argd = wash_urlargd(form, {'recid': (str, None), 'key': (str, None),
    ...
    def register_ill_request_step1(self, req, form):
        ...
        argd = wash_urlargd(form, {'recid': (str, None), 'user_info': (str, None),
                                    'ln': (str, "en")})
        recid = argd['recid']
        user_info = argd['user_info']
        ln = argd['ln']
    ...
    def register_ill_request_step2(self, req, form):
        ...
        argd = wash_urlargd(form, {'recid': (str, None), 'user_info': (str, None),
                ...
                'notes': (str, None), 'only_edition': (str, None), 'ln': (str, "en")})
        recid = argd['recid']
        user_info = argd['user_info']
    ...
    def register_ill_request_step3(self, req, form):
        ...
        argd = wash_urlargd(form, {'borrower_id': (str, None), 'request_info': (str, None),
                                    'ln': (str, "en")})
        borrower_id = argd['borrower_id']
        request_info = argd['request_info']
        ln = argd['ln']

        request_info = eval(request_info) #function not in use
    ...
    #    argd = wash_urlargd(form, {'request_info': (str, None), 'ill_status': (str, None),
    #                                    'ln': (str, "en")})
    #    request_info = argd['request_info']
    ...
    def ordered_books_details_step2(self, req, form):
        """    """
        argd = wash_urlargd(form, {'purchase_id': (str, None), 'recid': (str, None),
            'vendor_id': (str, None), 'cost': (str, None), 'currency': (str, None),
            'status': (str, None), 'order_date': (str, None), 'expected_date': (str, None),
            'purchase_notes': (str, None), 'library_notes': (str, None), 'ln': (str, "en")})
    ...
    def register_ill_request_from_borrower_page_step2(self, req, form):
        """http://cdsweb.cern.ch/admin2/bibcirculation/register_ill_request_with_no_recid_step2"""
        argd = wash_urlargd(form, {'borrower_id': (str, None), 'title': (str, None),
            'authors': (str, None), 'place': (str, None), 'publisher': (str, None),
            'year': (str, None), 'edition': (str, None), 'isbn': (str, None),
            'period_of_interest_from': (str, None), 'period_of_interest_to': (str, None),
            'additional_comments': (str, None), 'only_edition': (str, None), 'ln': (str, "en")})
        borrower_id = argd['borrower_id']
        title = argd['title']
        authors = argd['authors']
        place = argd['place']
        ...
        return bal.register_ill_request_from_borrower_page_step2(req, borrower_id, title,
                                                authors, place, publisher, year, edition, isbn,
                                                period_of_interest_from, period_of_interest_to,
                                                additional_comments, only_edition, ln)
    ...
    def register_ill_article_request_step2(self, req, form):
        ...
        argd = wash_urlargd(form, {'periodical_title': (str, None),
            'article_title': (str, None), 'author': (str, None), 'report_number': (str, None),
            'volume': (str, None), 'issue': (str, None), 'page': (str, None),
            'year': (str, None), 'budget_code': (str, ''), 'issn': (str, None),
            'period_of_interest_from': (str, None), 'period_of_interest_to': (str, None),
    ...
    def all_library_items(self, req, form):
        """http://cdsweb.cern.ch/admin2/bibcirculation/merge_libraries_step2"""
        argd = wash_urlargd(form, {'library_id': (int, None), 'ln': (str, "en")})

        library_id = argd['library_id']
        ln = argd['ln']

        return bal.all_library_items(req, library_id, ln)
