...
import invenio.websubmit_engine as websubmit_engine
from invenio.elmsubmit_misc import dict2file as _dict2file
import os.path
...
def handler(msg, submission_dict, elmconf):
    ...
    # Pass the submission to CDS Invenio proper:
