...
class EncodingRecognizer:
  ...
  CHARSET = [
    # zenkaku-kana
    (1.5, re.compile(u"[Çü-ÇÒ]"), 0x01),
    (1.5, re.compile(u"[É@-Éî]"), 0x02),
    (1.0, re.compile(u"[Å[ÅRÅSÅTÅU]"), 0x03),
    ...
    # zenkaku-alphanum
    (1.2, re.compile(u"[Ç`-ÇyÇÅ-ÇöÇO-ÇX]"), 0x10),
...
def test_suite():
  # kana only
  test(u"Ç±ÇÒÇ…ÇøÇÕ", ["japanese.euc_jp", "japanese.ms932", "utf8"])
  # kana + alphanum
  test(u"AÇÕBÇ∆CÇ≈Ç†ÇÈ", ["japanese.euc_jp", "japanese.ms932", "utf8"])
  # kana + kanji
  test(u"ñàí©êVï∑ÉjÉÖÅ[ÉX", ["japanese.euc_jp", "japanese.ms932", "utf8"])
  # kanji + hankakukana
  test(u"ñ≥ëËƒﬁ∑≠“›ƒ", ["japanese.ms932", "utf8"])
  # iso8859-1
