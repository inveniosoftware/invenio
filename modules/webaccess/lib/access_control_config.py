...
DEF_ROLES = ((SUPERADMINROLE, 'superuser with all rights', 'deny any'),
             ...
             ('CMPusers', 'Users who can use Claim My Papor', 'allow any'),
             ('CMPadmins', 'Users (librarians) who can administer CMP and resolve conflicts', 'deny any'))
...
DEF_ACTIONS = (
               ...
               ('cmp_view_pid_universe', 'View the CMP interface', '', 'no'),
               ('cmp_claim_own_papers', 'Clam papers to his own personID', '', 'no'),
               ('cmp_claim_others_papers', 'Claim papers for others', '', 'no'),
               ('cmp_change_own_data', 'Change data associated to his own person ID', '', 'no'),
               ('cmp_change_others_data', 'Change data of any person ID', '', 'no')
              )
...
DEF_AUTHS = (('basketusers', 'usebaskets', {}),
             ...
             ('CMPusers', 'cmp_view_pid_universe', {}),
             ('CMPadmins', 'cmp_view_pid_universe', {}),
             ('CMPusers', 'cmp_claim_own_papers', {}),
             ('CMPadmins', 'cmp_claim_own_papers', {}),
             ('CMPadmins', 'cmp_claim_others_papers', {}),
             ('CMPusers', 'cmp_change_own_data', {}),
             ('CMPadmins', 'cmp_change_own_data', {}),
             ('CMPadmins', 'cmp_change_others_data', {})
             )
...
CFG_ACC_ACTIVITIES_URLS = {
    ...
    'cmp_claim_others_papers' : (_("Run Person/Author Manager"), "%s/person/search?ln=%%s" % CFG_SITE_URL)
}
