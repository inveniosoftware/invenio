...
Revision 1.25 - Mapped 040e to <descriptiveStandard> and Leader/18 to <descriptive standard>aacr2  2008/09/18 2008/12/18 tmee
Revision 1.24 - Mapped 852 subfields $h, $i, $j, $k, $l, $m, $t to <shelfLocator> and 852 subfield $u to <physicalLocation> with @xlink 2008/09/17 tmee
...
-->
    ...
    <xsl:template name="url-encode">
        ...
        <xsl:template name="marcRecord">
                ...
                <xsl:for-each
                        select="datafield[@tag='130']|datafield[@tag='240']|datafield[@tag='730'][@ind2!='2']">
                ...
                <xsl:for-each
                        select="datafield[@tag=034][subfield[@code='d' or @code='e' or @code='f' or @code='g']]">
                        <subject>
                                <cartographics>
                                        <coordinates>
                                                <xsl:call-template name="subfieldSelect">
                ...
                <xsl:for-each
                        select="datafield[@tag=765]|datafield[@tag=767]|datafield[@tag=777]|datafield[@tag=787]">
                        <relatedItem>
                                <xsl:call-template name="relatedItem76X-78X"/>
                        </relatedItem>
                </xsl:for-each>
        ...
        <xsl:template name="nameABCDN">
                ...
                <xsl:if
                        test="subfield[@code='c'] or subfield[@code='d'] or subfield[@code='n']">
                        <namePart>
                                <xsl:call-template name="subfieldSelect">
