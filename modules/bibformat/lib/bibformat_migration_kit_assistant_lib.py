...
def getnavtrail(previous = '', ln=cdslang):
    ...
    navtrail = """<a class=navtrail href="%s/help/admin">%s</a> &gt; <a class=navtrail href="%s/admin/bibformat/bibformatadmin.py">%s</a> """ % (weburl, _("Admin Area"), weburl, _("BibFormat Admin"))
