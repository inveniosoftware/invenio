...
def create_database_tables():
    """
    Creates from scratch all the tables needed by the bibauthorid library.
    predefined sql file in etc directory

    This script is kept here as a development utility, to allow easy db tables
    creation without need of a reinstall of invenio.

    """
    run_sql('''
--
--WARNING: this creation scripts are carbon-copied in
--  miscutil/sql/tabcreate.sql to have all the tables created at
--  installation time.
--  Remember to propagate any changes!
-- They are kept here for ease of development and for further documentation
-- purposes. In some cases, field values are specified in more detail.
--

SET SQL_MODE="NO_AUTO_VALUE_ON_ZERO";

--
-- Table structure for table `aidAUTHORNAMES`
--
...
CREATE TABLE IF NOT EXISTS `aidAUTHORNAMES` (
  ...
  PRIMARY KEY (`id`),
  KEY `Name-b` (`Name`),
  KEY `db_Name-b` (`db_name`),
  KEY `bibrefs-b` (`bibrefs`),
  FULLTEXT KEY `Name-t` (`Name`),
  FULLTEXT KEY `db_Name-t` (`db_name`),
  FULLTEXT KEY `bibrefs-t` (`bibrefs`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `aidAUTHORNAMESBIBREFS`
--
...
CREATE TABLE IF NOT EXISTS `aidAUTHORNAMESBIBREFS` (
  ...
  PRIMARY KEY (`id`),
  KEY `Name_id-b` (`Name_id`),
  KEY `bibref-b` (`bibref`),
  FULLTEXT KEY `bibref-t` (`bibref`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `aidDOCLIST`
--
...
CREATE TABLE IF NOT EXISTS `aidDOCLIST` (
  ...
  PRIMARY KEY (`id`),
  KEY `bibrecID-b` (`bibrecID`),
  KEY `processed_author-b` (`processed_author`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `aidREALAUTHORDATA`
--
...
CREATE TABLE IF NOT EXISTS `aidREALAUTHORDATA` (
  ...
  `va_names_p` double NOT NULL DEFAULT '0' COMMENT 'Sum VA-Names probability',
  `va_p` double NOT NULL DEFAULT '0' COMMENT 'Summed VA probabilities',
  PRIMARY KEY (`id`),
  KEY `realauthorID-b` (`realauthorID`,`tag`),
  KEY `value-b` (`value`),
  KEY `tag-b` (`tag`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `aidREALAUTHORS`
--
...
CREATE TABLE IF NOT EXISTS `aidREALAUTHORS` (
  ...
  `p` float NOT NULL,
  PRIMARY KEY (`id`),
  KEY `realauthorID-b` (`realauthorID`),
  KEY `virtualauthorID-b` (`virtualauthorID`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `aidVIRTUALAUTHORS`
--
...
CREATE TABLE IF NOT EXISTS `aidVIRTUALAUTHORS` (
  ...
  PRIMARY KEY (`id`),
  KEY `authornamesID-b` (`authornamesID`),
  KEY `clusterID-b` (`clusterID`),
  KEY `virtualauthorID-b` (`virtualauthorID`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `aidVIRTUALAUTHORSCLUSTERS`
--
...
--
-- Table structure for table `aidVIRTUALAUTHORSDATA`
--
