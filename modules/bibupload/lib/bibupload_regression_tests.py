...
class GenericBibUploadTest(InvenioTestCase):
    ...
    def force_webcoll(self, recid):
        ...
        bibindex_engine.WordTable(index_name, index_tags, table_type=CFG_BIBINDEX_INDEX_TABLE_TYPE["Words"], tag_to_tokenizer_map={'8564_u': "BibIndexFulltextTokenizer"}).add_recIDs([[recid, recid]], 1)
