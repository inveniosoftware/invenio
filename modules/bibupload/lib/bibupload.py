...
from invenio.config import CFG_OAI_ID_FIELD, CFG_SITE_URL, \
     ...
     CFG_BIBUPLOAD_PROTECTED_PROVENANCE_TAGS
...
def delete_tags_to_correct(record, rec_old, opt_tag):
    ...
    deleted.
    """
    ## Some fields are protected. We should readd saved fields at the end.
    fields_to_readd = {}
    for tag in CFG_BIBUPLOAD_PROTECTED_PROVENANCE_TAGS:
        if tag[:3] in record:
    ...
    ## Ok, we readd the protected fields!
