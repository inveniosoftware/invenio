...
re_unicode_lowercase_i = re.compile(unicode(r"(?u)[íìïîı]", "utf-8"))
re_unicode_lowercase_l = re.compile(unicode(r"(?u)[ł]", "utf-8"))
...
re_unicode_uppercase_i = re.compile(unicode(r"(?u)[ÍÌÏÎI]", "utf-8"))
re_unicode_uppercase_l = re.compile(unicode(r"(?u)[Ł]", "utf-8"))
...
try:
    unichr(0x100000)
    RE_ALLOWED_XML_1_0_CHARS = re.compile(u'[^\U00000009\U0000000A\U0000000D\U00000020-\U0000007E\U00000080-\U0000D7FF\U0000E000-\U0000FFFD\U00010000-\U0010FFFF]')
    ...
    RE_ALLOWED_XML_1_0_CHARS = re.compile(u'[^\U00000009\U0000000A\U0000000D\U00000020-\U0000007E\U00000080-\U0000D7FF\U0000E000-\U0000FFFD]')
...
def strip_accents(x):
    ...
    y = re_unicode_lowercase_l.sub("l", y)
    ...
    y = re_unicode_uppercase_l.sub("L", y)
