/* Generated by Cython 0.11.2 on Wed Jul 15 10:47:29 2009 */
...
/* "/mnt/disk1/build/cds-invenio/modules/miscutil/lib/intbitset.pyx":745
 *     cdef IntBitSet *bitset
 * 
...
static int __pyx_pf_3lib_9intbitset_18intbitset_iterator___cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("__cinit__", 1, 1, 1, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 745; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("lib.intbitset.intbitset_iterator.__cinit__");
  return -1;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_bitset), __pyx_ptype_3lib_9intbitset_intbitset, 0, "bitset", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 745; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
/* "/mnt/disk1/build/cds-invenio/modules/miscutil/lib/intbitset.pyx":749
 *         self.bitset = bitset.bitset
 * 
 *     def __next__(self):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/mnt/disk1/build/cds-invenio/modules/miscutil/lib/intbitset.pyx":752
 *         self.last = intBitSetGetNext((<intbitset_iterator>self).bitset, self.last)
 *         if self.last < 0:
 *             self.last = -2             # <<<<<<<<<<<<<<
 *             raise StopIteration()
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2 = PyInt_FromLong(((struct __pyx_obj_3lib_9intbitset_intbitset_iterator *)__pyx_v_self)->last); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 754; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_r = __pyx_t_2;
  __pyx_t_2 = 0;
  goto __pyx_L0;
...
/* "/mnt/disk1/build/cds-invenio/modules/miscutil/lib/intbitset.pyx":756
 *         return self.last
 * 
 *     def __iter__(self):             # <<<<<<<<<<<<<<
 *         return self
...
static int __Pyx_InitCachedBuiltins(void) {
  ...
  __pyx_builtin_StopIteration = __Pyx_GetName(__pyx_b, __pyx_kp_StopIteration); if (!__pyx_builtin_StopIteration) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 753; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  return 0;
  __pyx_L1_error:;
  return -1;
}
