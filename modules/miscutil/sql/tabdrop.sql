...
DROP TABLE IF EXISTS oaiHOLDINGPEN;
...
DROP TABLE IF EXISTS fmtKNOWLEDGEBASES;
DROP TABLE IF EXISTS fmtKNOWLEDGEBASEMAPPINGS;
DROP TABLE IF EXISTS fmtKNOWLEDGEBASECOLL;
