...
DROP TABLE IF EXISTS bibwords10;
...
DROP TABLE IF EXISTS bibwords10r;
...
DROP TABLE IF EXISTS aceROLE;
DROP TABLE IF EXISTS user_aceROLE;
DROP TABLE IF EXISTS aceACTION;
DROP TABLE IF EXISTS aceARGUMENT;
DROP TABLE IF EXISTS aceROLE_aceACTION_aceARGUMENT;
